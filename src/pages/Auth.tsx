  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-[0.015]" style={{
        backgroundImage: `radial-gradient(circle at 2px 2px, hsl(30 8% 8%) 1px, transparent 0)`,
        backgroundSize: '32px 32px'
      }} />

      {/* Floating glass panel */}
      <Card className="w-full max-w-md relative backdrop-blur-glass bg-white/70 border-border/50 shadow-lg">
            ...
            <Tabs defaultValue="signin" className="w-full">
              ...
              <TabsContent value="signin">
                <div className="space-y-4">
                  <Button
                    type="button"
                    variant="outline"
                    className="w-full group hover:shadow-glow-sm transition-all duration-200"
                    onClick={handleGoogleSignIn}
                    disabled={loading}
                  >
                    <svg className="mr-2 h-4 w-4 text-text-secondary group-hover:text-accent-bronze transition-colors" viewBox="0 0 24 24" fill="currentColor">
                ...
                <form onSubmit={handleSignIn} className="space-y-5 mt-6">
                  <div className="space-y-2">
                    <Label htmlFor="signin-email" className="text-xs font-medium uppercase tracking-wider text-text-tertiary">Email</Label>
                    <Input
                      id="signin-email"
                      name="signin-email"
                      type="email"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="signin-password" className="text-xs font-medium uppercase tracking-wider text-text-tertiary">Password</Label>
                    <div className="relative">
                      <Input
                        id="signin-password"
                        ...
                        placeholder="••••••••"
                        required
                        className="pr-10 transition-all duration-200 focus:shadow-glow-sm"
                      />
                      <button
                        type="button"
              ...
              <TabsContent value="signup">
                ...
                <form onSubmit={handleSignUp} className="space-y-5 mt-6">
                  <div className="space-y-2">
                    <Label htmlFor="username" className="text-xs font-medium uppercase tracking-wider text-text-tertiary">Username *</Label>
                    <Input
                      id="username"
                      name="username"
                      type="text"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="display-name" className="text-xs font-medium uppercase tracking-wider text-text-tertiary">Display Name</Label>
                    <Input
                      id="display-name"
                      name="display-name"
                      type="text"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="signup-email" className="text-xs font-medium uppercase tracking-wider text-text-tertiary">Email *</Label>
                    <Input
                      id="signup-email"
                      name="signup-email"
                      type="email"
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="signup-password" className="text-xs font-medium uppercase tracking-wider text-text-tertiary">Password *</Label>
                    <div className="relative">
                      <Input
                        id="signup-password"
